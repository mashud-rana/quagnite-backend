...
class ApproveCoachDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($item) {
                ...
                if (auth()->user()->can('Block Coach')) {
                    $buttons .= '<form action="'.route('admin.coach.block', $item->id).'"  id="accept-form-'.$item->id.'" method="post" style="">
