        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($item) {
                ...
                if (auth()->user()->can('Show Contact')) {
                    $buttons .= '<a class="dropdown-item" href="'.route('admin.contact-us.show', $item->id).'" title="Show"><i class="mdi mdi-eye-circle-outline"></i> Show </a>';
                }
                if (auth()->user()->can('Delete Contact')) {
                    $buttons .= '<form action="'.route('admin.contact-us.destroy', $item->id).'"  id="delete-form-'.$item->id.'" method="post" style="">
