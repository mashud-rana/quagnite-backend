...
class BlogDataTable extends DataTable
{
        ...
        return datatables()
            ...
            ->addColumn('action', function ($item) {
                ...
                if (auth()->user()->can('Edit Blog')) {
                    $buttons .= '<a class="dropdown-item" href="'.route('admin.blog.edit', $item->id).'" title="Edit"><i class="mdi mdi-square-edit-outline"></i> Edit </a>';
                }

                if (auth()->user()->can('Delete Blog')) {
                    $buttons .= '<form action="'.route('admin.blog.delete', $item->id).'"  id="delete-form-'.$item->id.'" method="post" style="">
            ...
            })->editColumn('blog_category_id', function ($item) {
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('blog_category_id', 'blog_category_id')->title('Category'),
