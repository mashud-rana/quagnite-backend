...
class PaymentDataTable extends DataTable
{
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($item) {
                $buttons = '';
                $buttons .= '<a href="'.route('admin.invoice.view', $item->invoice->id).'" class="dropdown-item text-primary" title="View Invoice"><i class="mdi mdi-eye-outline"></i> View</a>';
                ...
                if (auth()->user()->can('Delete Payment')) {
                    $buttons .= '<form action="'.route('admin.payment.delete', $item->id).'"  id="delete-form-'.$item->id.'" method="post" style="">
    ...
    {
        return $model->newQuery()->with(['user', 'invoice'])->orderBy('id', 'DESC');
    }
