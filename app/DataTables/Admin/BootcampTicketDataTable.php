...
class BootcampTicketDataTable extends DataTable
{
    /**
    ...
    {
        return $model->where('ticket_for', GlobalConstant::TICKET_TYPE_BOOTCAMP)->newQuery()->orderBy('id', 'DESC');
    }
    ...
    {
        return 'Bootcamp_ticket_'.date('YmdHis');
    }
