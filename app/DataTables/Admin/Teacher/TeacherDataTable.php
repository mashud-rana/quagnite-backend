...
class TeacherDataTable extends DataTable
{
        ...
        return datatables()
            ...
            ->addColumn('action', function ($item) {
                ...
                if (auth()->user()->can('Edit Teacher')) {
                    $buttons .= '<a class="dropdown-item" href="'.route('admin.teachers.edit', $item->user_id).'" title="Edit"><i class="mdi mdi-square-edit-outline"></i> Edit </a>';
                }
     ...
     *
     * @param  \App\Models\Admin\Teacher  $model
