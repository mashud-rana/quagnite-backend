        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($item) {
                ...
                if (auth()->user()->can('Edit Announcement')) {
                    $buttons .= '<a class="dropdown-item" href="'.route('admin.announcement.edit', $item->id).'" title="Edit"><i class="mdi mdi-square-edit-outline"></i> Edit </a>';
                }

                if (auth()->user()->can('Delete Announcement')) {
                    $buttons .= '<form action="'.route('admin.announcement.destroy', $item->id).'"  id="delete-form-'.$item->id.'" method="post" style="">
