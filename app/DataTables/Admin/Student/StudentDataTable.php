        ...
        return datatables()
            ...
            ->addColumn('action', function ($item) {
                ...
                if (auth()->user()->can('Edit Student')) {
                    $buttons .= '<a class="dropdown-item" href="'.route('admin.students.edit', $item->user_id).'" title="Edit"><i class="mdi mdi-square-edit-outline"></i> Edit </a>';
                }
                ...
                if (auth()->user()->can('Delete Student')) {
                    $buttons .= '<form action="'.route('admin.students.destroy', $item->user_id).'"  id="delete-form-'.$item->id.'" method="post" style="">
                    <input type="hidden" name="_token" value="'.csrf_token().'">
