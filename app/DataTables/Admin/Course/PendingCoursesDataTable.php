...
class PendingCoursesDataTable extends DataTable
{
        ...
        return datatables()
            ...
            ->addColumn('action', function ($item) {
                ...
                if (auth()->user()->can('Hold Course')) {
                    $buttons .= '<a class="dropdown-item" href="'.route('admin.course.status.change', [$item->id, HOLD]).'" title="Hold"><i class="ri-flag-2-fill"></i> Hold </a>';
                }
    ...
    {
        return 'Admin\PendingCourses_'.date('YmdHis');
    }
}
