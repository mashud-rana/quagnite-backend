(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_events_EventReview_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/events/EventReview.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/events/EventReview.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  props: ['event_id', 'add_comment_permission', 'is_applied'],
  data: function data() {
    return {
      add_comment: true,
      is_error: false,
      ...
      total_review: 0,
      review_next_page_url: null,
      reviews: []
    };
  },
  mounted: function mounted() {
    if (this.add_comment_permission != undefined) {
      this.add_comment = this.add_comment_permission;
    }

    if (this.is_applied && this.is_applied.status == 'confirmed') {
      this.add_comment = true;
    } else {
      this.add_comment = false;
    } // Get first batch of review


    this.getFirstBatchReview();
  },
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this.is_error = false; // Simple validation

                if (_this.form_data.rating == 0) {
                  _this.is_error = true;
                  _this.errors.rating = true;
                }

                if (_this.form_data.comment == '') {
                  _this.is_error = true;
                  _this.errors.required = true;
                }

                if (_this.form_data.comment.length > 100) {
                  _this.is_error = true;
                  _this.errors.max_length = true;
                } // Submit review
                ...
                _context.next = 7;
                return axios.post("/events/review/".concat(_this.event_id), {
                  rating: _this.form_data.rating,
                  comment: _this.form_data.comment
                }).then(function (res) {
                  _this.form_data.rating = 0;
                  _this.form_data.comment = '';
                  _this.is_error = false;

                  _this.getFirstBatchReview();
                })["catch"](function (err) {
    ...
    getFirstBatchReview: function getFirstBatchReview() {
      var _this2 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this2.reviews = [];
                _context2.next = 3;
                return axios.get("/events/review/".concat(_this2.event_id)).then(function (res) {
                  _this2.reviews = res.data.data.data || [];
                  _this2.review_next_page_url = res.data.data.next_page_url || null;
                  _this2.total_review = res.data.data.total || 0;
                })["catch"](function (err) {
                  console.log(err);
                });
    ...
    viewMoreComment: function viewMoreComment() {
      var _this3 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return axios.get(_this3.review_next_page_url).then(function (res) {
                  var _this3$reviews;

                  (_this3$reviews = _this3.reviews).push.apply(_this3$reviews, _toConsumableArray(res.data.data.data || []));

                  _this3.review_next_page_url = res.data.data.next_page_url || null;
                  _this3.total_review = res.data.data.total || 0;
                })["catch"](function (err) {
                  console.log(err);
                });
  ...
  watch: {
    form_data: {
      handler: function handler(val) {
        ...
        if (val.comment.length <= 200) {
          this.errors.max_length = false;
        }
      },
      deep: true
    }
...
/***/ "./resources/js/components/events/EventReview.vue":
/*!********************************************************!*\
  !*** ./resources/js/components/events/EventReview.vue ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _EventReview_vue_vue_type_template_id_15a9bbf2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EventReview.vue?vue&type=template&id=15a9bbf2& */ "./resources/js/components/events/EventReview.vue?vue&type=template&id=15a9bbf2&");
/* harmony import */ var _EventReview_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./EventReview.vue?vue&type=script&lang=js& */ "./resources/js/components/events/EventReview.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _EventReview_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _EventReview_vue_vue_type_template_id_15a9bbf2___WEBPACK_IMPORTED_MODULE_0__.render,
  _EventReview_vue_vue_type_template_id_15a9bbf2___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/events/EventReview.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/events/EventReview.vue?vue&type=script&lang=js&":
/*!*********************************************************************************!*\
  !*** ./resources/js/components/events/EventReview.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EventReview_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EventReview.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/events/EventReview.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EventReview_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/events/EventReview.vue?vue&type=template&id=15a9bbf2&":
/*!***************************************************************************************!*\
  !*** ./resources/js/components/events/EventReview.vue?vue&type=template&id=15a9bbf2& ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EventReview_vue_vue_type_template_id_15a9bbf2___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EventReview_vue_vue_type_template_id_15a9bbf2___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EventReview_vue_vue_type_template_id_15a9bbf2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EventReview.vue?vue&type=template&id=15a9bbf2& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/events/EventReview.vue?vue&type=template&id=15a9bbf2&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/events/EventReview.vue?vue&type=template&id=15a9bbf2&":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/events/EventReview.vue?vue&type=template&id=15a9bbf2& ***!
  \******************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function () {
  ...
  return _c("div", [
    _c("div", { staticClass: "ic-event-details-reviews" }, [
      _c("div", { staticClass: "title mb-40" }, [
        _c("h3", { staticClass: "color-blue" }, [
          _vm._v("Reviews "),
          _c("span", { staticClass: "color-blue" }, [
            _vm._v(_vm._s(_vm._f("addLeadingZeros")(this.total_review))),
          ]),
        ]),
      ]),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "ic-event-reviews-item-wraper" },
        _vm._l(_vm.reviews, function (review, index) {
          return _c("div", { key: "index", staticClass: "ic-reviews-item" }, [
            _c("div", { staticClass: "user-profile" }, [
              _c("img", {
                attrs: { src: review.user.avatar_url, alt: "avatar" },
              }),
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "reviews-content" }, [
              _c("div", { staticClass: "name mb-8" }, [
                _c("h4", { staticClass: "sub-1 color-ebonyClay" }, [
                  _vm._v(_vm._s(review.user.full_name)),
                ]),
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "reviews mb-16" }, [
                _c(
                  "p",
                  [
                    _vm._l(review.rating, function (item) {
                      return _c("i", { staticClass: "ri-star-s-fill" })
                    }),
                    _vm._v(" "),
                    _vm._l(5 - review.rating, function (item) {
                      return _c("i", { staticClass: "ri-star-s-line" })
                    }),
                  ],
                  2
                ),
      ...
      _vm._v(" "),
      _c("div", { staticClass: "ic-view-more-reviews" }, [
        this.review_next_page_url
          ? _c(
              "a",
              {
                staticClass: "sub-1 color-shuttleGray",
                attrs: { href: "javascript:void(0)" },
                on: { click: _vm.viewMoreComment },
              },
              [_vm._v("View\n                More")]
            )
          : _vm._e(),
    ...
    _vm._v(" "),
    _vm.add_comment
      ? _c("div", { staticClass: "ic-event-details-comment padding-24" }, [
          _vm._m(0),
          _vm._v(" "),
          _c("div", { staticClass: "ic-give-rating mb-40" }, [
            _c("h4", { staticClass: "color-shuttleGray" }, [
              _vm._v("Give Your Rating First"),
            ]),
            _vm._v(" "),
            _c(
              "div",
              ...
              [
                _c("star-rating", {
                  ...
                  model: {
                    value: _vm.form_data.rating,
                    callback: function ($$v) {
                      _vm.$set(_vm.form_data, "rating", $$v)
                    },
                    expression: "form_data.rating",
                  },
                }),
                _vm._v(" "),
                _vm.errors.rating
                  ? _c("p", { staticClass: "text-danger w-100 font-size-11" }, [
                      _vm._v("Please add a rating"),
                    ])
                  : _vm._e(),
              ],
              1
          ...
          _c("div", { staticClass: "comment-box" }, [
            _c("textarea", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.form_data.comment,
                  expression: "form_data.comment",
                },
              ],
              ...
              domProps: { value: _vm.form_data.comment },
              on: {
                input: function ($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.form_data, "comment", $event.target.value)
                },
              },
            }),
            _vm._v(" "),
            _vm.errors.required
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.errors.max_length
              ? _c("p", { staticClass: "text-danger w-100 font-size-11" }, [
                  _vm._v(
                    "Comment not be greater than 200\n                characters"
                  ),
                ])
              : _vm._e(),
            _vm._v(" "),
            _c(
              "button",
              {
                staticClass: "btn btn-sm btn-dark float-end mt-2",
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "title mb-40" }, [
      _c("h3", { staticClass: "color-ebonyClay" }, [
        _vm._v("Leave Your Comments"),
      ]),
    ])
  },
]
