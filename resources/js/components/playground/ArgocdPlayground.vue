            ...
            <div class="ic-codePlayground--main-code d-block bg-white">
              <div class="ic-terminal-header">
                <ul class="ic-tabs-terminal row">
                  <li class="col-auto"><a href="#">Terminal</a></li>
                  <li class="col-auto">
                    <a :href="getArgocdUrl()" target="_blank">
                      Argo CD UI
...
export default {
  ...
  methods: {
    async getLabInfo() {
      await axios
        .get("/playground/argocd/provision")
