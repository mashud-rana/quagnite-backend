            ...
            <div class="ic-codePlayground--main-code d-block bg-white">
              <div class="ic-terminal-header">
                <ul class="ic-tabs-terminal row">
                  ...
                  <li class="col-auto">
                    <a :href="getGrafanaUrl()" target="_blank">
                      Grafana
                      <i class="ri-arrow-right-up-line"></i>
                    </a>
                  </li>
                  <li class="col-auto">
                    <a :href="getPrometheusUrl()" target="_blank">Prometheus
                      <i class="ri-arrow-right-up-line"></i>
                    </a>
                  </li>
                </ul>
...
export default {
  ...
  methods: {
    async getLabInfo() {
      await axios
        .get("/playground/grafana-prometheus/provision")
    ...
    endLab(url) {
      ...
      axios
        .post("/playground/grafana-prometheus/labEnd", {
          url: url,
        })
        .then((response) => {
    ...
    getGrafanaUrl() {
      if (this.url.startsWith("https://")) {
        ...
        let modifyUrl = this.url.replace("https://", "http://");
