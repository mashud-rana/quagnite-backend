    ...
    <div class="aws-info">
      ...
      <div v-if="!loader">
        ...
        <ul>
          ...
          <li>
            <span class="color-deep-gray">Username : </span
          ...
          <li>
            <span class="color-deep-gray">Password : </span
            ><span ref="password">{{ password }}</span>
            <i
              class="ri-file-copy-line"
          ...
          <li>
            <span class="color-deep-gray">Expires in : </span
            ><span v-if="duration">
              <countdown
                ref="countdown"
                :time="labDuration"
...
export default {
  ...
  methods: {
    async getLabInfo() {
      await axios.get("/playground/gcp/provision").then((response) => {
        let gcp = response.data.data;
        ...
        if (gcp.url) {
          this.loader = false;
          this.url = gcp.url;
          this.username = gcp.username;
          this.password = gcp.password;
          this.duration = gcp.duration;
          this.labId = gcp.lab_id;
        }
      });
    },
    endLab(labId) {
