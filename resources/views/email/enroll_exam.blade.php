                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Congratulations on taking the next step in your educational journey! You
                                            have successfully enrolled in <strong>{{ $data->exam['title'] }}</strong>.
                                        </p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            We are excited to support you in this endeavor and wish you the best of luck
                                            in your studies and upcoming exams. If you have any questions or need
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © {{ date('Y') }} {{ config('settings.mail_from_name') }}. All rights
                                            reserved.</p>
