...
@section('content')
    <div class="ic-header-admin">
        <div class="ic-CourseBack-btn">
            <a href="{{ route('teacher.course.index') }}" class="ic-backPage-button"><i class="ri-arrow-left-s-line"></i> Back
                to
                Courses</a>
        </div>
    </div>
                                ...
                                <div class="ic-review-comment pt-0">
                                    <div class="ic-textArea ic-discussions-heads">
                                        <img src="{{ getStoreFile(auth()->user()->avatar, auth()->user()->storage_type) }}"
                                            alt="">
                                        <form action="{{ route('teacher.course.discussion.submit') }}" method="POST"
                                                        ...
                                                        <div class="me-text post">
                                                            ...
                                                            <div class="ic-user-comment-show">
                                                                ...
                                                                <div class="ic-comment-massages">
                                                                    <form
                                                                        action="{{ route('teacher.course.discussion.comment.submit') }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('POST')
                                    ...
                                    <div class="accordion-body">
                                        <ul>
                                            @foreach ($lesson->lecture as $lecture)
                                                <li>
                                                    <a
                                                        href="{{ route('teacher.course.show', ['slug' => $course->slug, 'lessonUuid' => $lesson->uuid, 'lectureUuid' => $lecture->uuid]) }}">
                                                        <div class="ic-video-milestone">
                                            ...
                                            @if ($lesson->questions_count)
                                                <li>
                                                    <a href="{{ route('teacher.course.show', ['slug' => $course->slug, 'lessonUuid' => $lesson->uuid, 'lectureUuid' => 'quiz']) }}"
