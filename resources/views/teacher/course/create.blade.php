                        ...
                        <div class="tab-content h-auto">
                            ...
                            <form action="{{ route('teacher.course.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="course_category_id" class="selectpicker">
                                                        ...
                                                        @foreach ($courseCategories as $item)
                                                            <option
                                                                {{ $item->id == old('course_category_id') ? 'selected' : '' }}
                                    ...
                                    <div class="ic-tab-heder">
                                        <p>Course Thumbnail & Introduction Video</p>
                                    </div>
                                    <div class="ic-form-tabs pb-3">
                                        <div class="row gy-sm-3 gy-2">
                                            ...
                                            <div class="col-lg-6 ">
                                                <div class="ic-video-upload-form">
                                                    <p class="fs-20 ff-lexend black pb-lg-3 pb-2">Course Introduction Video
                                                        (Optional)
                                                    </p>
                                                    <ul>
                                                        <li>
