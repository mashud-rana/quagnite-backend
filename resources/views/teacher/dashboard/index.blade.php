                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-4 justify-content-center">
                                <h4 class="card-title font-size-20">Semester Progress</h4>
                            </div>
                            <div class="text-center pb-4">
                                <input class="s-progress" data-width="150" data-height="150" data-linecap=round
                                    data-fgColor="#11849E" value="55" data-skin="tron" data-angleOffset="180"
        ...
        <div class="col-xl-4 col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <button class="btn btn-primary btn-lg mt-3 w-100">View All</button>
                </div>
            </div>
        </div>
    </div>
