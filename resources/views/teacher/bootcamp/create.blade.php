                ...
                <div class="card-body">
                    ...
                    <div id="smartwizard" class="ic-create-course-step">
                        ...
                        <div class="tab-content h-auto">
                            {{-- Course Store Form --}}
                            <form action="{{ route('teacher.bootcamp.store') }}" method="POST"
                                ...
                                <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="title" type="text" class="form-control"
                                                        value="{{ old('title') }}" placeholder="Bootcamp Title">
                                                </div>
                                                @error('title')
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="subtitle" type="text" class="form-control"
                                                        value="{{ old('subtitle') }}" placeholder="Bootcamp Subtitle">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="bootcamp_category_id" class="selectpicker">
                                                        ...
                                                        @foreach ($bootcampCategories as $item)
                                                            <option
                                                                {{ $item->id == old('bootcamp_category_id') ? 'selected' : '' }}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="tag_id[]" class="selectpicker" multiple>
                                                        @foreach ($tags as $item)
                                                            <option
                                                                {{ is_array(old('tag_id')) ? (in_array($item->id, old('tag_id')) ? 'selected' : '') : '' }}
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="learner_accessibility" class="selectpicker"
                                                        ...
                                                        <option
                                                            {{ COURSE_ACCESS_PAID === old('learner_accessibility') ? 'selected' : '' }}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="course_language_id" class="selectpicker">
                                                        ...
                                                        @foreach ($bootcampLanguages as $item)
                                                            <option
                                                                {{ $item->id === old('course_language_id') ? 'selected' : '' }}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="difficulty_level_id" class="selectpicker">
                                                        ...
                                                        @foreach ($difficultyLevels as $item)
                                                            <option
                                                                {{ $item->id === old('difficulty_level_id') ? 'selected' : '' }}
                                                                value="{{ $item->id }}"> {{ $item->title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <button type="submit" class="ic-btn">Save & Continue</button>
                                </div>
                            </form>
                            {{-- End Step 01 --}}
