...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="ic-banner-content">
                        ...
                        <h1 class="white pb-15 banner-heading">Empowering Your Career with the Ultimate All-In-One IT
                            Training Solution.
                        </h1>
                        <div class="row">
                            <div class="col-xxl-10 col-lg-12">
                                <p class="color-deep-gray pb-30">Our all-in-one platform offers tailored training solutions that are
                                    specifically designed to meet the needs of individuals and businesses alike. With our
                                    comprehensive courses and expert instructors, you can gain the skills and knowledge you
                                    need to succeed in the fast-paced </p>
                ...
                <div class="col-lg-6">
                    <div class="ic-banner-images">
                        <img src="{{ asset('/new-frontend/images/banner-right-img.png') }}" alt=""
    ...
    {{-- popular topic --}}
    <section class="ic-popular-topic"
        style="background-image: linear-gradient(180deg, rgba(46, 183, 211, 0.95) 0.01%, rgba(6, 115, 138, 0.95) 100%), url({{ asset('/new-frontend/images/popular-topic.png') }}) ">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-3">
                    <div class="ic-popular-topic-text">
                        <p class="fs-24 fw-500 white pb-2">MCdns Popular topics To learn now</p>
                        <a href="#" class="text-underline white"><u>View all technologies</u></a>
                    </div>
                </div>
                <div class="col-lg-9">
                    <div class="ic-popular-topic-logos">
                        <div class="ic-popular-topic-items">
                            <img src="{{ asset('new-frontend/images/popular-topic-1.png') }}" class="img-fluid"
                                alt="mcdns">
                        </div>
                        <div class="ic-popular-topic-items">
                            <img src="{{ asset('new-frontend/images/popular-topic-2.png') }}" class="img-fluid"
                                alt="mcdns">
                        </div>
                        <div class="ic-popular-topic-items">
                            <img src="{{ asset('new-frontend/images/popular-topic-3.png') }}" class="img-fluid"
                                alt="mcdns">
                        </div>
                        <div class="ic-popular-topic-items">
                            <img src="{{ asset('new-frontend/images/popular-topic-4.png') }}" class="img-fluid"
                                alt="mcdns">
                        </div>
                        <div class="ic-popular-topic-items">
                            <img src="{{ asset('new-frontend/images/popular-topic-5.png') }}" class="img-fluid"
                                alt="mcdns">
                        </div>
                        <div class="ic-popular-topic-items">
                            <img src="{{ asset('new-frontend/images/popular-topic-6.png') }}" class="img-fluid"
                                alt="mcdns">
                        </div>
                        <div class="ic-popular-topic-items">
                            <img src="{{ asset('new-frontend/images/popular-topic-7.png') }}" class="img-fluid"
                                alt="mcdns">
                        </div>
                        <div class="ic-popular-topic-items">
                            <img src="{{ asset('new-frontend/images/popular-topic-8.png') }}" class="img-fluid"
                                alt="mcdns">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="ic-thousands-maps">
                        <div class="ic-man-images">
                            <img src="{{ asset('new-frontend/images/reach-out.png') }}" class="ic-statagis w-100"
                                alt="">
                            ...
                            <div class="ic-statistic">
                                ...
                                <img src="{{ asset('new-frontend/images/statistic.png') }}" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                    </div>
    ...
    {{-- bootcamp --}}
    {{-- student dashboard --}}
    <section class="ic-student-dashboard ic-section-space bg-shade"
        ...
        <div class="container">
            ...
            <div class="row g-4 g-md-5 align-items-center">
                <div class="col-lg-5">
                    <div class="ic-student-dashboard-text">
                        <h3 class="fw-28 white mb-30">At MCdns Learning we offer persona lized learning experiences through
                            our adaptive learning technology.</h3>
                        <p class="white fw-300 mb-30">Empower your tech teams to produce key business outcomes by making
                            upskilling and reskilling as easy as powering up their laptop. Tap into the power of curated
                            learning paths to guide teams through the exact skills they need to progress from a variety of
                            tech skills.</p>
                        <a href="#" class="ic-btn-white">View All Coureses <i class="ri-arrow-right-line"></i></a>
                    </div>
                </div>
    ...
    <section class="ic-enroll-lateset-courses ic-section-space ">
        <div class="container">
            <div class="ic-headers">
    ...
    <section class="ic-strategies-part ic-section-space bg-shade">
        <div class="container">
            <div class="ic-headers text-center">
                <p class="ic-borderWith-whiteBg mb-15">Unique Process</p>
                <h2 class="black">Our Strategies Process</h2>
            </div>
            <div class="ic-our-strategies-plan">
                <div class="ic-our-strategies-process-styled">
                    <div class="row g-3">
                        <div class="col-lg-7 order-2 order-lg-1">
                            <div class="ic-our-strategies-process-text">
                                <h2>01. Students Counseling</h2>
                                <p class="fw-300">Empower your tech teams to produce key business outcomes by making
                                    upskilling
                                    and reskilling as easy as powering up their laptop. Tap into the power of curated
                                    learning
                                    paths to guide teams through the exact skills they need to progress from novice to guru
                                    across a variety of tech skills.</p>
                                <a href="#" class="ic-btn">View All Coureses <i
                                        class="ri-arrow-right-line"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-5 order-1 order-lg-2">
                            <div class="ic-our-strategies-process">
                                <img src="{{ asset('new-frontend/images/process-1.png') }}" class="process-img"
                                    alt="">
                                <img src="{{ asset('new-frontend/images/images-vactor.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="ic-our-strategies-process-styled">
                    <div class="row g-3">
                        <div class="col-lg-5">
                            <div class="ic-our-strategies-process">
                                <img src="{{ asset('new-frontend/images/process-2.png') }}" class="process-img"
                                    alt="">
                                <img src="{{ asset('new-frontend/images/images-vactor.png') }}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="ic-our-strategies-process-text">
                                <h2>02. Success Coach Assignment</h2>
                                <p class="fw-300">Empower your tech teams to produce key business outcomes by making
                                    upskilling
                                    and reskilling as easy as powering up their laptop. Tap into the power of curated
                                    learning
                ...
                <div class="ic-our-strategies-process-styled">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-5 order-1 order-lg-2">
                            <div class="ic-our-strategies-process">
                                <img src="{{ asset('new-frontend/images/process-3.png') }}" class="process-img"
                                    alt="">
                                <img src="{{ asset('new-frontend/images/images-vactor.png') }}" alt="">
                            </div>
                        </div>
                ...
                <div class="ic-our-strategies-process-styled">
                    <div class="row g-3">
                        <div class="col-lg-5">
                            <div class="ic-our-strategies-process">
                                <img src="{{ asset('new-frontend/images/process-4.png') }}" class="process-img"
                                    alt="">
                                <img src="{{ asset('new-frontend/images/images-vactor.png') }}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="ic-our-strategies-process-text">
                                <h2>04. Company-Based Projects</h2>
                                <p class="fw-300">Empower your tech teams to produce key business outcomes by making
                                    upskilling
                                    and reskilling as easy as powering up their laptop. Tap into the power of curated
                                    learning
                ...
                <div class="ic-our-strategies-process-styled">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-5 order-1 order-lg-2">
                            <div class="ic-our-strategies-process">
                                <img src="{{ asset('new-frontend/images/process-5.png') }}" class="process-img"
                                    alt="">
                                <img src="{{ asset('new-frontend/images/images-vactor.png') }}" alt="">
                            </div>
                        </div>
                ...
                <div class="ic-our-strategies-process-styled">
                    <div class="row g-3">
                        <div class="col-lg-5">
                            <div class="ic-our-strategies-process">
                                <img src="{{ asset('new-frontend/images/process-6.png') }}" class="process-img"
                                    alt="">
                                <img src="{{ asset('new-frontend/images/images-vactor.png') }}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="ic-our-strategies-process-text">
                                <h2>06. Monthly Proctored Exams</h2>
                                <p class="fw-300">Empower your tech teams to produce key business outcomes by making
                                    upskilling
                                    and reskilling as easy as powering up their laptop. Tap into the power of curated
                                    learning
                ...
                <div class="ic-our-strategies-process-styled">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-5 order-1 order-lg-2">
                            <div class="ic-our-strategies-process">
                                <img src="{{ asset('new-frontend/images/process-7.png') }}" class="process-img"
                                    alt="">
                                <img src="{{ asset('new-frontend/images/images-vactor.png') }}" alt="">
                            </div>
                        </div>
                ...
                <div class="ic-our-strategies-process-styled">
                    <div class="row g-3">
                        <div class="col-lg-5">
                            <div class="ic-our-strategies-process">
                                <img src="{{ asset('new-frontend/images/process-8.png') }}" class="process-img"
                                    alt="">
                                <img src="{{ asset('new-frontend/images/images-vactor.png') }}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="ic-our-strategies-process-text">
                                <h2>08. Interview Preparation</h2>
                                <p class="fw-300">Empower your tech teams to produce key business outcomes by making
                                    upskilling
                                    and reskilling as easy as powering up their laptop. Tap into the power of curated
                                    learning
    ...
    {{-- playground status --}}
    <section class="ic-playground-part ic-section-space bg-g-shade">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row g-4">
                        <div class="col-lg-6 position-relative">
                            <div class="ic-student-video-process bg-white border-0">
                                <div class="ic-student-vedio">
                                    <div class="plyr__video-embed player2">
                                        <iframe src="https://www.youtube.com/watch?v=HIMk-JlOPAA" allowfullscreen
                        ...
                        <div class="col-lg-6">
                            <div class="ic-playground-content">
                                ...
                                <p class="color-deep-gray pb-30 ">Our hands-on labs are limited by both time and the topic.
                                    ...
                                    solutions. Our hands-on labs are limited by both time and the topic. Playgrounds in
                                    MCdns Learning Plus are blank, clean environments intended for you to tinker with. Each
                                    playground can be extended, giving you all the time you need to test solutions.
                                    Playgrounds in MCdns Learning Plus are blank.</p>
                            </div>
                        </div>
                    </div>
    ...
    <!-- trust each -->
    <section class="ic-trust-me ic-section-space">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="ic-our-partner">
                        <p class="ic-borderWith-whiteBg mb-15">OUR PARTNER</p>
                        <h2><span class="primary">We Have Worked</span> with them, We Trust Each Other</h2>
                        <div class="ic-bars"></div>
                        <p class="color-deep-gray">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
                            in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Empower your
                            tech teams to produce key business outcomes by making upskilling and reskilling as easy as
                            powering up their laptop. Tap into the power of curated learning paths to guide teams through
                            the exact skills they need to progress from novice to guru across a variety of tech skills.</p>
                        <ul>
                            <li>
                            ...
                            <li>
                                <i class="ri-check-double-line"></i>
                                Potentiële groeikansen
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="ic-partner-images">
                        <div class="ic-partner-logos">
                            <div class="ic-partner-logos-items">
                                <img src="{{ asset('new-frontend/images/partner-1.png') }}" class="img-fluid"
                                    alt="">
                            </div>
                            <div class="ic-partner-logos-items">
                                <img src="{{ asset('new-frontend/images/partner-2.png') }}" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                        <div class="ic-partner-logos">
    ...
    <section class="ic-team-employee--main ic-section-space-top-80 bg-white">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="ic-comming-soon-page">
                        ...
                        <div class="ic-comming-soon-content">
                            ...
                            <img src="{{ asset('new-frontend/images/coming-soon.png') }}" class="img-fluid"
                                alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="barcodes">
                        <p class="fs-18 fw-500 pt-4 text-center pb-2">Scan this QR code on your camera app to download the
                            app
                        </p>
                        <img src="{{ asset('new-frontend/images/barcode.png') }}" class="mb-30 mt-30 barcode-imd"
                            alt="">
                        <div class="ic-apps-store">
                            <a href="#">
                                <img src="{{ asset('/new-frontend/images/apple.png') }}" alt="">
...
@push('scripts')
    <script>
        ...
        const player_sec = new Plyr('.player2', {
            controls: [
                'play-large',
                'restart',
                // 'rewind',
        ...
        setTimeout(() => {
            player_sec.poster = '/new-frontend/images/process-vide.png';
        }, 500);
