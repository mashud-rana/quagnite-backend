...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="ic-right-side-img">
                        <img src="{{ asset('new-frontendv1/images/coaches-single/banner-img.png') }}" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="ic-discover-section ic-section-space-top ic-section-space-bottom-104">
        ...
        <div class="container">
            <div class="ic-caoches-single-card-area">
                <div class="justify-content-center row g-xl-4 g-sm-3 g-2">
    ...
    <section class="ic-freelance-coach-section overflow-hidden">
                ...
                <div class="ic-freelance-coach-content">
                    <div class="ic-freelance-coach-card-wrapper">
                        ...
                        <div class="ic-freelance-desc">
                            ...
                            <div class="btn-div">
                                <a href="{{ route('front.allCoaches') }}" class="ic-btn">Explore All Coaches <i
                ...
                <div class="ic-counter-wrapper">
                    <div class="ic-counter-item">
                        <div class="ic-counter-box">
                            <span class="ic-conter-number" data-vanilla-counter data-start-at="0" data-end-at="834"
                                data-time="2000">{}M</span>
                    ...
                    <div class="ic-counter-item">
                        <div class="ic-counter-box">
                            <span class="ic-conter-number" data-vanilla-counter data-start-at="0" data-end-at="790"
                                data-time="2000">{}M</span>
                    ...
                    <div class="ic-counter-item">
                        <div class="ic-counter-box">
                            <span class="ic-conter-number" data-vanilla-counter data-start-at="0" data-end-at="90"
                                data-time="2000">{}M</span>
                    ...
                    <div class="ic-counter-item">
                        <div class="ic-counter-box">
                            <span class="ic-conter-number" data-vanilla-counter data-start-at="0" data-end-at="275"
                                data-time="2000">{}M</span>
                                ...
                                <div class="col-sm-6">
                                    <div class="ic-text-box">
                                        ...
                                        <p>Sample text. Click to select
                                            ...
                                            the text.</p>
                                        <a href="{{ route('all.bootcamps') }}">All Bootcamp</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="ic-img-wrapper">
                            <div class="row g-0 ic-bootcamp-box">
                                <div class="col-sm-6">
                                    <div class="ic-text-box">
                                        <h2>Live <span>Coaching</span></h2>
                                        <p>Sample text. Click to select
                                            the text box. Click again or
                                            double click to start editing
                                            the text.</p>
                                        <a href="{{ route('front.allCoaches') }}">All Coaches</a>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="ic-img-box">
...
@push('scripts')
    ...
    <script src="{{ asset('new-frontendv1/js/counter.js') }}"></script>
    <script>
        VanillaCounter()
    </script>
    {{-- counter --}}
