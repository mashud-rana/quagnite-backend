...
@section('content')
            ...
            <div class="row align-items-center gy-3">
                <div class="col-lg-7 order-2 order-lg-1">
                    <div class="ic-banner-content ps-0 pe-0">
                        ...
                        <div class="">
                            <a href="#mostPopular" class="ic-btn-simple">Enroll for an exam <i
                ...
                <div class="col-lg-5 order-1 order-lg-2">
                    <div class="ic-right-side-img">
                        <img src="{{ asset('new-frontendv1/images/blog/blog-banner-right.png') }}" alt=""
                            class="img-fluid">
                    </div>
                </div>
            </div>
    ...
    <section class="ic-test-assignment">
        <div class="container">
            <div class="row g-3">
                <div class="col-lg-6">
                    <div class="ic-test-assessment h-100">
                        <img src="{{ asset('new-frontendv1/images/blog/test-assestent.png') }}" class="img-fluid h-100"
                ...
                <div class="col-lg-6">
                    <div class="ic-test-assessment-content">
                        ...
                        <div class="mt-30">
                            <a href="#recentlyAdded" class="ic-btn-simple">Explore All Exams <i
                                    class="ri-arrow-right-line"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <section class="ic-get-started ic-section-space" id="mostPopular">
        <div class="container">
            <div class="section-headers-playground text-center">
                <h2 class="black">Most popular exams</h2>
            </div>
            <div class="row g-3" id="topExamContainer">
                @forelse($topExams as $item)
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="ic-exam-test-iq">
                            <span class="ic-timer-set"><i class="ri-timer-line"></i> {{ $item->formatted_time }}</span>
                            <img src="{{ getStoreFile($item->image, $item->storage_type) }}" class="img-fluid"
                                alt="">
                            <h6>{{ $item->title }}</h6>
                            <div class="d-flex align-items-center gap-2 justify-content-center pb-2">
                                <sapn>${{ $item->price }}</sapn>
                                <span class="text-decoration-line-through">${{ $item->old_price }}</span>
                            </div>
                            @if ($isSubscriptionAvailable)
                                <button data-exam_id="{{ $item->id }}" data-route="{{ route('addToSubscribe') }}"
                                    class="ic-btn-simple addToSubscribe">Subscribe Now</button>
                            @else
                                <button data-exam_id="{{ $item->id }}" data-route="{{ route('addToCart') }}"
                                    class="ic-btn-simple addToCart">Add to cart <i
                                        class="ri-shopping-cart-2-line"></i></button>
                            @endif
                        </div>
                    </div>
                @empty
            ...
            @if ($topExams->hasMorePages())
                <div class="mt-50 text-center">
                    <button id="topExamLoadMore" class="ic-btn-simple" data-next-page="{{ $topExams->nextPageUrl() }}">Load
                        More</button>
                </div>
            @endif
            {{-- <div class="mt-50 text-center">
        ...
        <div class="container">
            ...
            <div class="ic-discover-main"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="ic-dicover-post">
                                ...
                                <div>
                                    ...
                                    <p>The gold standard for demonstrating your technical skill proficiency is
                                        certification,
                                        and we'll assist you make sure you're prepared. Schedule your certifications, manage
                                        your learning toward a specific certification, and practice your skills through
                                        hands-on
                ...
                <div class="ic-discover-items-right">
                    <img src="{{ asset('new-frontendv1/images/blog/discover-right.png') }}" class="img-fluid"
                        alt="">
                </div>
            </div>
        </div>
    ...
    <section class="ic-popular-proctored ic-section-space position-relative" id="recentlyAdded">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto">
                    <div class="section-headers-playground text-center">
                        <h2 class="black">Recently Added Exams</h2>
                    </div>
                </div>
            </div>
            <div class="ic-proctored-exams">
                <div class="row g-3" id="recentExamContainer">
                ...
                @if ($recentExams->hasMorePages())
                    <div class="mt-50 text-center">
                        <button id="recentExamLoadMore" class="ic-btn-simple"
                            data-next-page="{{ $recentExams->nextPageUrl() }}">Load
                            More</button>
                    </div>
                @endif
            </div>
            ...
            <div class="row row-cols-5">
                <div class="col">
                    <div class="ic-badge-img">
                        <img src="{{ asset('new-frontendv1/images/blog/badge-img.png') }}" class="img-fluid"
                            alt="">
                    </div>
                </div>
                <div class="col">
        ...
        <div class="container">
            <div class="ic-routed-get-items ic-shadow-divs">
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-7 col-lg-8 order-2 order-lg-1">
                        <div class="ic-routed-get-content me-lg-3">
                            ...
                            <p>The gold standard for demonstrating your technical skill proficiency is certification, and
                                ...
                                your students.</p>
                            <a href="#" class="ic-btn-simple">Explore All Exams <i
                                    class="ri-arrow-right-line"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 order-1 order-lg-2">
                        <div class="ic-routed-get-img">
                            <div class="ic-routed-get-img-inner position-relative">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            triggerLoadMoreEvent('topExamLoadMore', 'topExamContainer');
            triggerLoadMoreEvent('recentExamLoadMore', 'recentExamContainer');
        });
    </script>
@endpush
