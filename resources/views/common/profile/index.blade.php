            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <form id="adminAvatarUpdateForm" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="avatar-upload">
                                    <div class="avatar-edit">
                                        <input type='file' name="avatar" id="adminImageUpload"
                                            accept=".png, .jpg, .jpeg" />
                                        <label for="adminImageUpload"></label>
                                    </div>
                                    <div class="avatar-preview">
                                        <div id="imagePreview" style="background-image: url('{{ getStoreFile($user->avatar, $user->storage_type) }}');">
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="col-md-6">
                            <form action="{{ route('user.profile.update', $user->id) }}" method="POST" id="form">
                                @csrf
                                @method('PUT')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <form action="{{ route('user.update.password') }}" method="POST" id="form2">
                                @csrf
