            ...
            <div class="ic-footer-row">
                ...
                <div class="ic-col">
                    <div class="ic--footer--heading">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="#">Linux System Engineer</a>
                            </li>
                            <li>
                                <a href="#">DevOps</a>
                            </li>
                            <li>
                                <a href="#">Jira Project Administrator</a>
                            </li>
                            <li>
                                <a href="#">AWS Cloud Architect</a>
                            </li>
                            <li>
                                <a href="#">Azure Administrator </a>
                            </li>
                            <li>
                                <a href="#">Google cloud architecture</a>
                            </li>
                            <li>
                ...
                <div class="ic-col">
                            ...
                            <div class="ic--footer--heading">
                                ...
                                <ul class="ic__address--contact">
                                    <li>
                                        ...
                                        <p>9200 Bustleton Ave Suite 1612 Philadelphia, PA 19115</p>
                                    </li>
                                    <li>
                                        <div class="contact-logo">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        ...
                                        <a href="mailto:touch@mcdns.tech">learning@mcdns.tech</a>
                                    </li>
                                    <li>
                                        <div class="contact-logo">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        ...
                                        <a href="tel:+1 (267) 406-8357">+1 (267) 406-8357</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="ic-apps-wrapper mt-50">
                        <a href="#">
                            <div class="ic_app">
                                <img class="img-fluid" src="{{ asset('new-frontend/images/apple.svg') }}" alt="">
                            </div>
                        </a>
                        <a href="#">
                        <div class="ic_app">
                                <img class="img-fluid" src="{{ asset('new-frontend/images/google.svg') }}" alt="">
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="ic-footer-bottom">
                ...
                <div class="right-content">
                    <p>(c) {{ date('Y') }} MCdns, LLC All rights reserved.</p>
                </div>
