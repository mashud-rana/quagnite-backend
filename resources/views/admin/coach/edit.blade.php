        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.coaches.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="coach_category_id">
                                @foreach ($coachCategory as $item)
                                    <option value="{{ $item->id }}" @if ($user->coach->coach_category_id == $item->id) selected @endif>
                                        {{ $item->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="professional_title" class="form-control" required=""
                                placeholder="Professional Title" value="{{ old('professional_title', $user->coach->professional_title) }}">
