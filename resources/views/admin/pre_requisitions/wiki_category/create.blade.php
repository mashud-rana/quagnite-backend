        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.wiki-category.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            <div>
                                ...
                                <a class="btn btn-secondary waves-effect" href="{{ route('admin.wiki-category.index') }}">
