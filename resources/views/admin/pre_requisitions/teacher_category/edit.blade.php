        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.teacher-categories.update', $item->id) }}" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" id="status_yes" name="status" class="form-check-input" value="1"
                                    name="status" class="custom-control-input"
                                    @if ($item->status == 1) checked @endif>
                                <label class="custom-control-label" for="status_yes">Active</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" id="status_no" name="status" class="form-check-input" value="0"
                                    name="status" class="custom-control-input"
