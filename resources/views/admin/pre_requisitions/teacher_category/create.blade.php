        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.teacher-categories.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" id="status_yes" value="1" name="status" class="form-check-input"
                                    checked="">
                                <label class="custom-control-label" for="status_yes">Active</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" id="status_no" value="0" name="status" class="form-check-input">
                        ...
                        <div class="mb-3">
                            <div>
                                ...
                                {{-- @can('All teacher Categories') --}}
                                <a class="btn btn-secondary waves-effect"
                                    href="{{ route('admin.teacher-categories.index') }}">
