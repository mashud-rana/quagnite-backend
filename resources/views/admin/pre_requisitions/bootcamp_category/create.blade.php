        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.bootcamp-categories.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            <div>
                                ...
                                {{-- @can('All bootcamp Categories') --}}
                                <a class="btn btn-secondary waves-effect"
                                    href="{{ route('admin.bootcamp-categories.index') }}">
