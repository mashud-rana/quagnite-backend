        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.playground.questions.store') }}" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <input id="inputTrix" type="hidden" name="title" value="{{ old('title') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input name="options[]" type="text" class="form-control"
                                    placeholder="Enter Option A Input" required>
                            </div>
                            <div class="col-md-12 mb-3">
                                <div class="form-check form-check-inline">
                                ...
                                <input name="options[]" type="text" class="form-control"
                                    placeholder="Enter Option B Input">
                            </div>
                            <div class="col-md-12 mb-3">
                                <div class="form-check form-check-inline">
                                ...
                                <input name="options[]" type="text" class="form-control"
                                    placeholder="Enter Option C Input">
                            </div>
                            <div class="col-md-12 mb-3">
                                <div class="form-check form-check-inline">
                                ...
                                <input name="options[]" type="text" class="form-control"
                                    placeholder="Enter Option D Input">
                            </div>
                        </div>
                        {{-- Options --}}
