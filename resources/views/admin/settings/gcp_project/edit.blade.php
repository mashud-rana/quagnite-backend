        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.gcpProject.update', $gcp->id) }}" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <input name="project_name" type="text" class="form-control" required=""
                                placeholder="Project Name" value="{{ old('project_name') ?? $gcp->project_name }}">
                            @error('project_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input name="project_no" type="text" class="form-control" required=""
                                placeholder="Project Number" value="{{ old('project_no') ?? $gcp->project_no }}">
                            @error('project_no')
                                <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input name="project_id" type="text" class="form-control" required=""
                                placeholder="Project ID" value="{{ old('project_id') ?? $gcp->project_id }}">
                            @error('project_id')
                                <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input name="project_url" type="text" class="form-control" required=""
                                placeholder="Project Url" value="{{ old('project_url') ?? $gcp->project_url }}">
                            @error('project_url')
                                <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input name="user_role" type="text" class="form-control" required=""
                                placeholder="User Role" value="{{ old('user_role') ?? $gcp->user_role }}">
                            @error('user_role')
                                <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
