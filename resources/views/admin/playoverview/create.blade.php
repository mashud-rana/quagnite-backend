        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.playground.overview.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            <div>
                                ...
                                <a class="btn btn-secondary waves-effect" href="{{ route('admin.playground.overview.index') }}">
