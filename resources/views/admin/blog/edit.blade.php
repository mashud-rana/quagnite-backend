        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.blog.update', $blog->uuid) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control select2" name="tag_ids[]" multiple>
                                ...
                                @foreach ($tags as $tag)
                                    <option value="{{ $tag->id }}"
                                        {{ in_array($tag->id, $blogTags) ? 'selected' : '' }}>
                                        {{ $tag->name }}</option>
                                @endforeach
                            </select>
                            @error('tag_ids')
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div id='img_contain'>
                                <img id="image-preview" align='middle' src="{{ getStoreFile($blog->image, $blog->storage_type) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="inputTrix" type="hidden" name="details" value="{{ $blog->details }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" id="status_yes" value="{{ PUBLISHED }}" name="status" class="form-check-input"
                                    {{ $blog->status == PUBLISHED ? 'checked' : '' }}>
                                <label class="custom-control-label" for="status_yes">Published</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" id="status_no" value="{{ DRAFT }}" name="status" class="form-check-input"
                        ...
                        <div class="mb-3">
                            <div>
                                ...
                                <a class="btn btn-secondary waves-effect" href="{{ route('admin.blog.index') }}">
