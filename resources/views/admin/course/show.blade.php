...
@section('content')
    <div class="ic-header-admin">
        <div class="ic-CourseBack-btn">
            <a href="{{ route('admin.course.all') }}" class="ic-backPage-button"><i class="ri-arrow-left-s-line"></i> Back
                to
                panel</a>
        </div>
    </div>
                                    ...
                                    <div class="accordion-body">
                                        <ul>
                                            @foreach ($lesson->lecture as $lecture)
                                                <li>
                                                    <a
                                                        href="{{ route('admin.course.show', ['slug' => $course->slug, 'lessonUuid' => $lesson->uuid, 'lectureUuid' => $lecture->uuid]) }}">
                                                        <div class="ic-video-milestone">
