                            ...
                            <div class="col-lg-12">
                                <div class="ic-create-question-wrapper">
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        <a href="{{ route('admin.course.edit.content', $course->uuid) }}"
                                    ...
                                    {{-- add questions --}}
                                    <div id="addQuestion"
                                        class="ic-create-question-content d-none p-0 border-0 shadow-none">
                                        <form action="{{ route('admin.course.quizes.store') }}" method="POST">
                                            @csrf
                                            @method('POST')
                                            ...
                                            <div class="ic-content-wrapper">
                                                ...
                                                <div class="ic-content-footer">
                                                    ...
                                                    <button type="submit" class="ic-btn btn-primary rounded">Save
                                                        Question</button>
                                                </div>
                                            </div>
                                        </form>
                                        ...
                                        @foreach ($questions as $key => $question)
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapse-{{ $key }}"
                                                    ...
                                                    <div
                                                        class="accordion-body ic-create-question-content p-0 mt-3 border-0 shadow-none">
                                                        <form
                                                            action="{{ route('admin.course.quizes.update', $question->id) }}"
                                                            method="POST">
                                                            @csrf @method('POST')
                                                            ...
                                                            <div class="ic-content-wrapper">
                                                                ...
                                                                <div class="ic-content-footer">
                                                                    <button type="submit"
                                                                        class="ic-btn btn-primary rounded">update
                                                                        Question</button>
                                                        </form>
                                                        <form
                                                            action="{{ route('admin.course.quizes.destroy', $question->id) }}"
