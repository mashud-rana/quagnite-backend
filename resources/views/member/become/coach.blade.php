        ...
        <div class="container">
            <div class="ic-member-become-main mt-30">
                <div class="ic-become-banner-post"
                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <h3 class="white">Do you want to be a Coach?</h3>
                ...
                @if ($is_applied)
                    <div class="pt-60 pb-60 text-center">
                        ...
                        <p class="text-center fs-24">Application Submitted Successfully <br> Please Wait for approval</p>
                    </div>
                @else
                    <div class="become-form">
                        <form action="{{ route('member.submitBecomeACoach') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="coach_category_id" class="form-select" id="">
                                            <option disabled>Select catagory</option>
                                            @foreach ($categories as $item)
                                                <option value="{{ $item->id }}"
                                                    @if (old('coach_category_id') == $item->id) @selected(true) @endif>
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
