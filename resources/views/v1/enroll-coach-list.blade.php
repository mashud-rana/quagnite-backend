    ...
    <section class="ic-student-dashboard pb-4">
        <div class="container">
            <div class="section-headers">
                <div>
                    <h3 class="fs-30 fw-700 pb-3">My Courses</h3>
                            ...
                            <div class="col">
                                <div class="ic-v1-bootcams-items">
                                    ...
                                    <div class="ic-list-conetnt">
                                        <p class="sub-title">Md. Mainuddin Sani</p>
                                        <div class="list-conetnt-info">
                                            <div class="bootcams-course-details">
                                                <p><i class="ri-calendar-check-fill"></i> 21 Feb, 2023</p>
                                                <p><i class="ri-time-line"></i> 23 04:30 PM - 05:30 PM</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-btn pt-3 d-flex align-items-center gap-2">
                                        <a href="#" class="ic-btn-outline-md">
                                            <i class="ri-live-fill"></i> Add Live
                                        </a>
                                        <a href="#" class="ic-btn-outline-md">
                                            Activities
                                        </a>
