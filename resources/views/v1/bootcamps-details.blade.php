...
@section('content')
    ...
    <section class="ic-banner-part"
        style="background-image: linear-gradient(0deg, rgba(231, 237, 238, 0.95), rgba(231, 237, 238, 0.95)), url({{ asset('/new-frontend/images/bootcamps-banner-bg.png') }})">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-8">
    ...
    <section class="ic-course-curriulum pb-30 ic-section-space-top-80">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6 ic-curiculam-right">
                    <div class="accordion ic-course-video-all ic-video-according" id="accordionExample">
                                    ...
                                    <div class="ic-video-milestone">
                                        ...
                                        <div class="ic-course-video">
                                            <h6><img src="{{ asset('frontend/images/video-icons.svg') }}" alt="">
                                                Milestone 0
                                                : Orientation</h6>
                                            <span class="video-times"><i class="ri-calendar-2-line"></i> Aug 23, 2022 22:00
                                                - Aug 25, 2022 22:00 (UTC)</span>
                                        </div>
                                    </div>
                                </button>
                            </div>
                                ...
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <div class="ic-video-milestone">
                                        ...
                                        <div class="ic-course-video">
                                            ...
                                            <span class="video-times"><i class="ri-calendar-2-line"></i> Aug 23, 2022
                                                22:00 - Aug 25, 2022 22:00 (UTC)</span>
                                        </div>
                                    </div>
                                </button>
                            </h2>
    ...
    <section class="ic-course-details ic-section-space-bottom-80 pt-0">
        <div class="container">
            <div class="ic-course-tabs pb-0 bootcapms-tabs">
                <div class="ic-tabs-links">
                    <ul>
                        ...
                        {{-- <li>
                            <a href="#" class="ic-discription-links" data-tabs="course-rating-tabs">Course
                                Rating</a>
                        </li> --}}
                        <li>
                ...
                <div class="tabs-content mt-0">
                                ...
                                <div class="ic-user-review-shows">
                                    <div class="ic-user-review-avatar">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="user-review-sent d-flex flex-wrap align-items-center">
                    ...
                    <div class="ic-tabs-content-items " id="discussions">
                        {{-- instructor --}}
                        <div class="instructior-divs">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="ic-instructor-left">
                                        <div class="ic-online-isntructor-names">
                                            <h3 class="fs-30 fw-500 purple">Online Bootcamp</h3>
                                            <span class="ic-badge primary">Remote, from anywhere</span>
                                        </div>
                                        <p class="fw-300 gray pb-2">Get the same interactivity and access to the instructor
                                            as
                                            in-person students. There are no extra fees and we’ll work with you to ensure
                                            your remote setup is perfect.</p>
                                        <ul>
                                            <li>
                                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M8.33333 16.8334C3.73083 16.8334 0 13.1025 0 8.50002C0 3.89752 3.73083 0.166687 8.33333 0.166687C12.9358 0.166687 16.6667 3.89752 16.6667 8.50002C16.6667 13.1025 12.9358 16.8334 8.33333 16.8334ZM7.5025 11.8334L13.3942 5.94085L12.2158 4.76252L7.5025 9.47669L5.145 7.11919L3.96667 8.29752L7.5025 11.8334Z"
                                                        fill="#00ACB6" />
                                                </svg>
                                                <span class="color-deep-gray">Live, interactive class</span>
                                            </li>
                                            <li>
                                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="color-deep-gray">Experienced instructor teaching over Zoom</span>
                                            </li>
                                            <li>
                                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="color-deep-gray">Remote setup assistance provided</span>
                                            </li>
                                            <li>
                                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="color-deep-gray">Current Enrolled 500 Hundred Student</span>
                                            </li>
                                            <li>
                                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="color-deep-gray">Share your screen with the instructor</span>
                                            </li>
                                            <li>
                                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="color-deep-gray">Watch and hear the instructor's screen
                                                    real-time</span>
                                            </li>
                                            <li>
                                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                                ...
                                                <span class="color-deep-gray">Speak to the instructor using your computer audio,
                                                    phone.</span>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-lg-7">
                                    <div class="row g-3 ic-instructor-main">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="ic-instructor-info">
                                                <img src="{{ asset('new-frontend/images/instructor.png') }}"
                                                    class="img-fluid w-100" alt="">
                                                <div class="ic-instruc-content">
                                                    <p class="fs-20 fw-500 primary pb-1">Leslie Alexander</p>
                                                    <p class="fs-14 gray pb-1 extra-small">Sr. Web Designer | Hybrids</p>
                                                    <p class="fs-14 gray pb-1 extra-small">10 Years Experienced</p>
                                                    <ul>
                                                        <li>
                                                            <img src="{{ asset('new-frontend/images/maps-icon.png') }}"
                                                                alt="">
                                                            London, UK
                                                        </li>
                                                        <li>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="instructor-static">
                                                <img src="{{ asset('new-frontend/images/static-img.png') }}"
                                                    class="img-fluid w-100" alt="">
                                            </div>
                                        </div>
                                    </div>
