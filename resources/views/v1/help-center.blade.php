...
<section class="ic-section-space ic-help-center-part" style="background-image: url({{asset('new-frontendv1/images/help-center/help-center.png')}})">
    <div class="container">
        ...
        <div class="ic-help-catagories-grid">
            <div class="row g-5">
                <div class="col-lg-4">
                    <a href="#">
                        <div class="help-catagories-items">
                            <img src="{{asset('new-frontendv1/images/help-center/plane.png')}}" class="img-fluid" alt="plane">
                            <h5>Getting Started</h5>
                            <p>Lorem ipsum is placeholder text commonly commonly used in site.</p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4">
                    <a href="#">
                        <div class="help-catagories-items">
                            <img src="{{asset('new-frontendv1/images/help-center/user.png')}}" class="img-fluid" alt="plane">
                            <h5>Getting Started</h5>
                            <p>Lorem ipsum is placeholder text commonly commonly used in site.</p>
                        </div>
                    </a>
                ...
                <div class="col-lg-4">
                    <a href="#">
                        <div class="help-catagories-items">
                            <img src="{{asset('new-frontendv1/images/help-center/trouble.png')}}" class="img-fluid" alt="plane">
                            <h5>Getting Started</h5>
                            <p>Lorem ipsum is placeholder text commonly commonly used in site.</p>
                        </div>
                    </a>
                ...
                <div class="col-lg-4">
                    <a href="#">
                        <div class="help-catagories-items">
                            <img src="{{asset('new-frontendv1/images/help-center/purchase.png')}}" class="img-fluid" alt="plane">
                            <h5>Getting Started</h5>
                            <p>Lorem ipsum is placeholder text commonly commonly used in site.</p>
                        </div>
                    </a>
                ...
                <div class="col-lg-4">
                    <a href="#">
                        <div class="help-catagories-items">
                            <img src="{{asset('new-frontendv1/images/help-center/course-taking.png')}}" class="img-fluid" alt="plane">
                            <h5>Getting Started</h5>
                            <p>Lorem ipsum is placeholder text commonly commonly used in site.</p>
                        </div>
                    </a>
                ...
                <div class="col-lg-4">
                    <a href="#">
                        <div class="help-catagories-items">
                            <img src="{{asset('new-frontendv1/images/help-center/mobile-general.png')}}" class="img-fluid" alt="plane">
                            <h5>Getting Started</h5>
                            <p>Lorem ipsum is placeholder text commonly commonly used in site.</p>
                        </div>
                    </a>
                ...
                <div class="col-lg-4">
                    <a href="#">
                        <div class="help-catagories-items">
                            <img src="{{asset('new-frontendv1/images/help-center/booking.png')}}" class="img-fluid" alt="plane">
                            <h5>Getting Started</h5>
                            <p>Lorem ipsum is placeholder text commonly commonly used in site.</p>
                        </div>
                    </a>
                ...
                <div class="col-lg-4">
                    <a href="#">
                        <div class="help-catagories-items">
                            <img src="{{asset('new-frontendv1/images/help-center/payment.png')}}" class="img-fluid" alt="plane">
                            <h5>Getting Started</h5>
                            <p>Lorem ipsum is placeholder text commonly commonly used in site.</p>
                        </div>
                    </a>
                ...
                <div class="col-lg-4">
                    <a href="#">
                        <div class="help-catagories-items">
                            <img src="{{asset('new-frontendv1/images/help-center/booking-change.png')}}" class="img-fluid" alt="plane">
                            <h5>Getting Started</h5>
                            <p>Lorem ipsum is placeholder text commonly commonly used in site.</p>
                        </div>
                    </a>
