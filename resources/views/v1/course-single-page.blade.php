            ...
            <div class="ic-row">
                <div class="ic-col">
                    <div class="ic-course-main-img">
                        <img src="{{asset('/new-frontendv1/images/course-single/course-main.png')}}" class=" img-fluid"
                            alt="">
                    </div>
                </div>
                <div class="ic-col">
                    ...
                    <div class="ic-bottom-content">
                        ...
                        <div class="ic-abs-content-btn mb-30">
                            <a role="button" class="ic-btn" href="">
                                Explore All Course
            ...
            <div class="ic-about-col">
                <div class="ic-discover-card">
                    ...
                    <div class="bottom-content">
                        <img src="{{asset('/new-frontendv1/images/course-single/card.png')}}" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
            <div class="ic-about-col">
                <div class="ic-discover-card">
                    ...
                    <div class="bottom-content">
                        <img src="{{asset('/new-frontendv1/images/course-single/card3.png')}}" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
            <div class="ic-about-col">
                <div class="ic-discover-card">
                    ...
                    <div class="bottom-content">
                        <img src="{{asset('/new-frontendv1/images/course-single/card4.png')}}" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
            <div class="ic-about-col">
                <div class="ic-discover-card">
                    ...
                    <div class="bottom-content">
                        <img src="{{asset('/new-frontendv1/images/course-single/card5.png')}}" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<section class="ic-enroll-course ic-single-course-common ic-section-space ">
    <div class="container">
    ...
    <div class="item">
        <div class="ic-coach-item">
            <div class="position-relative overflow-hidden">
                <p class="coach-bage ff-exend fs-14 color-white">in Development</p>
                <a href="#" class="wishlist"><i class="ri-heart-3-line"></i></a>
                <img src="{{asset('/new-frontendv1/images/course-single/card4.png')}}"
    ...
    <div class="item">
        <div class="ic-coach-item">
            <div class="position-relative overflow-hidden">
                <p class="coach-bage ff-exend fs-14 color-white">in Development</p>
                <a href="#" class="wishlist"><i class="ri-heart-3-line"></i></a>
                <img src="{{asset('/new-frontendv1/images/course-single/card5.png')}}"
                    class="img-fluid ic-coach-image w-100" alt="">
            </div>
            <div class="ic-coach-content">
                <h5 class="fw-500 coach-title ff-lexend">asdasdasdasdasd</h5>
    ...
    <div class="item">
        <div class="ic-coach-item">
            <div class="position-relative overflow-hidden">
                <p class="coach-bage ff-exend fs-14 color-white">in Development</p>
                <a href="#" class="wishlist"><i class="ri-heart-3-line"></i></a>
                <img src="{{asset('/new-frontendv1/images/course-single/card.png')}}"
                    class="img-fluid ic-coach-image w-100" alt="">
            </div>
            <div class="ic-coach-content">
                <h5 class="fw-500 coach-title ff-lexend">asdasdasdasdasd</h5>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="ic-coach-item">
                <div class="position-relative overflow-hidden">
                    <p class="coach-bage ff-exend fs-14 color-white">in Development</p>
                    <a href="#" class="wishlist"><i class="ri-heart-3-line"></i></a>
                    <img src="{{asset('/new-frontendv1/images/course-single/card2.png')}}"
                        class="img-fluid ic-coach-image w-100" alt="">
                </div>
                <div class="ic-coach-content">
                    <h5 class="fw-500 coach-title ff-lexend">asdasdasdasdasd</h5>
    ...
    <div class="mt-30 text-center">
        <a href="#" class="ic-btn">Explore All Course <i class="ri-arrow-right-line"></i></a>
    </div>
        ...
        <div class="ic-better-technology-row">
            <div class="ic-better-technology-col">
                ...
                <ul class="ic-feature">
                    <li>
                        <div class="icon">
                            <img src="{{asset('/new-frontendv1/images/course-single/stack.svg')}}" class="img-fluid"
                                alt="">
                        </div>
                        <div class="feature-content">
                            <h5 class="feature-title">Upskill & reskill</h5>
                            <p class="feature-des">Etiam sed vulputate nisl, eu elementum arcu. Vivamus dignissim tortor
                            </p>
                            <a class="feature-details" href="">Read All Course</a>
                        </div>
                    </li>
                    <li>
                        <div class="icon">
                        ...
                        <div class="feature-content">
                            ...
                            <p class="feature-des">Vivamus dignissim tortor in tellus dictum pellentesque. Praesent
                                mauris</p>
                            <a class="feature-details" href="">Explore Lab</a>
                        </div>
                    </li>
                    <li>
                        <div class="icon">
                        ...
                        <div class="feature-content">
                            ...
                            <a class="feature-details" href="">See All Exams</a>
                        </div>
                    </li>
                    <li>
                        <div class="icon">
                        ...
                        <div class="feature-content">
                            ...
                            <p class="feature-des">Vivamus dignissim tortor in tellus dictum pellentesque. Praesent
                                mauris</p>
                            <a class="feature-details" href="">See All Bootcamp</a>
                        </div>
                    </li>
                </ul>
            </div>
            <div class="ic-better-technology-col">
                <div class="image">
                    <img src="{{asset('/new-frontendv1/images/course-single/better-technology.png')}}" class="img-fluid"
                        alt="">
                </div>
            </div>
        </div>
