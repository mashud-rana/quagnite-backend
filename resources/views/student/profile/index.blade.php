        ...
        <div class="container">
            <div class="ic-profile__setting">
                ...
                <div class="ic-profile__tabsContent">
                    <form action="{{ route('student.profile.update', $user->id) }}" method="POST" id="form"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="address"
                                            placeholder="Your Address Line" value="{{ $user->student->address ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="about_me" id="" class="form-control" cols="30" rows="10"
                                            placeholder="Beautiful super large botanical garden - amazing it’s in NYC. Getting into the garden with my voucher was easy and seamless! Just went up to the ticket counter and went right in.">{{ $user->student->about_me ?? '' }}</textarea>
                    ...
                    <form action="{{ route('student.update.password') }}" method="POST" id="form2">
                        @csrf
