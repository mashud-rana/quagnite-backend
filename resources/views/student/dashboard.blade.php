        ...
        <div class="container">
            ...
            <div class="ic-dashboard__header">
                <div class="header-left">
                    ...
                    <div>
                        ...
                        <p class="color-deep-gray">{{ \Carbon\Carbon::now()->format('jS F Y, l') }}</p>
                    </div>
                </div>
                <a href="{{ route('student.profile') }}" class="ic-btn-outline">Edit Profile <i
                ...
                <div class="row row-cols-2 row-cols-sm-3 row-cols-md-3 row-cols-lg-4 g-2 g-xl-2 g-xxl-4">
                    <div class="col">
                        <div class="ic-dashboard-card student-dashboard-card"
                            ...
                            <div class="ic-dash-content">
                                <p class="card-title mb-13">Course Completed</p>
                                <h4 class="mb-13">{{ $auth_user->student->course_completed_count ?? 0 }}</h4>
                                {{-- <a href="#">All Student <i class="ri-arrow-right-s-line"></i></a> --}}
                            </div>
                    ...
                    <div class="col">
                        <div class="ic-dashboard-card student-dashboard-card"
                            ...
                            <div class="ic-dash-content">
                                <p class="card-title mb-13">Course in Progress</p>
                                <h4 class="mb-13">{{ $auth_user->student->course_progress_count ?? 0 }}</h4>
                                {{-- <a href="#">All Student <i class="ri-arrow-right-s-line"></i></a> --}}
                            </div>
                            <div class="ic-dash-icon">
                    ...
                    <div class="col">
                        <div class="ic-dashboard-card student-dashboard-card"
                            ...
                            <div class="ic-dash-content">
                                <p class="card-title mb-13">Bootcamp Completed</p>
                                <h4 class="mb-13">{{ $auth_user->student->bootcamp_completed_count ?? 0 }}</h4>
                                {{-- <a href="#">All Student <i class="ri-arrow-right-s-line"></i></a> --}}
                            </div>
                            <div class="ic-dash-icon">
                                <img src="{{ asset('new-frontendv1/images/coach-dashboard/sassion.png') }}"
                    ...
                    <div class="col">
                        <div class="ic-dashboard-card student-dashboard-card"
                            ...
                            <div class="ic-dash-content">
                                <p class="card-title mb-13">Bootcamp in Progress</p>
                                <h4 class="mb-13">{{ $auth_user->student->bootcamp_progress_count ?? 0 }}</h4>
                                {{-- <a href="#">All Student <i class="ri-arrow-right-s-line"></i></a> --}}
                            </div>
                            <div class="ic-dash-icon">
            ...
            {{-- <div class="row g-3">
                <div class="col-lg-4 col-md-6">
                    <div class="ic-widget__card ic-gradient1">
                        ...
                        <a href="{{ route('exams.index') }}" class="ic-widget__btn">Take An Exam <i
                                class="ri-arrow-right-s-line"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="ic-widget__card ic-gradient2">
                        ...
                        <p class="white">Start with the DevOps Learning Path Cloud
                            Playgrounds</p>
                        <a href="{{ route('playground.index') }}" class="ic-widget__btn">Check Playground Here <i
                                class="ri-arrow-right-s-line"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="ic-widget__card ic-gradient3">
                        ...
                        <a href="{{ route('all.courses') }}" class="ic-widget__btn">Find a popular Course <i
                                class="ri-arrow-right-s-line"></i></a>
                    </div>
                </div>
            </div> --}}
            ...
            {{-- <div class="getForBusiness mt-30">
                <h4 class="primary">Work In a MCDns? <span class="orange body-font">Business type of company to enroll their
                        students</span></h4>
                <a href="{{ route('business.index') }}" class="btn-book">Get For Business</a>
            </div> --}}
            {{-- get button --}}

            {{-- pickup left --}}
            <div class="row">
                <div class="col-lg-8 mt-30 md-mt-0">
                    <div class="ic-pickUp h-100">
                        <div class="ic-pickUp__headers">
                            ...
                            <div class="ic-pickUp__tabsEnrolled">
                                <a href="#" class="ic-pickUp__links active"
                                    data-link="enrollCourse"><span>Enrolled</span>
                                    Courses</a>
                        ...
                        <div class="ic-pickUp__content">
                            <div class="ic-pickUp__enrollCourse active" id="enrollCourse">
                                ...
                                @forelse ($data['enroll_courses'] as $item)
                                    <div class="ic-pickUp__courseItems">
                                        <div class="ic-pickUp__img overflow-hidden">
                                        ...
                                        <div class="ic-pickUp__courseInfo d-flex flex-column justify-content-between">
                                            <div>
                                                <h4 class="fw-600 pb-4">{{ $item->course->title }}</h4>
                                                <div class="progress">
                                            ...
                                            <div class="pt-4">
                                                <a href="{{ route('student.show-course', $item->course->slug) }}"
                                                    class="ic-pickUp__btn">Continue <i
                                                        class="ri-arrow-right-s-line"></i></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="ic-pickUp__enrollCourse" id="enrollBootcamps">
                                @forelse ($data['enroll_bootcamps'] as $item)
                                    <div class="ic-pickUp__courseItems">
                                        <div class="ic-pickUp__img position-relative overflow-hidden">
                                            <img src="{{ getStoreFile($item->bootcamp->image, $item->bootcamp->storage_type) }}"
                                                alt="">
                                            <p class="ic-pickUp__names">{{ $item->bootcamp->user->full_name }}</p>
                                        </div>
                                        <div class="ic-pickUp__courseInfo">
                                            <h4 class="fw-600">{{ $item->bootcamp->title }}</h4>

                                            <ul class="enrolled-bootcamps">
                                                <li>
                                                    <i class="ri-calendar-check-line"></i>
                                                    <span>Bootcamp start
                                                        {{ \Carbon\Carbon::parse($item->bootcamp->start_date)->format('d M, Y') }}</span>
                                                </li>
                                            ...
                                            <a href="{{ route('student.show-bootcamp', $item->bootcamp->slug) }}"
                                                class="ic-pickUp__btn">Join Class <i class="ri-arrow-right-s-line"></i></a>
                                        </div>
                                    </div>
                                @empty
                                    <x-frontend.data-notfound></x-frontend.data-notfound>
                ...
                <div class="col-lg-4">
                    <div class="ic-pricePlan__card ic-gradient4 mt-30">
                        <p class="white fs-20">You currently have free, limited access to <span
                            ...
                            labs.</p>
                        <a href="{{ route('all.pricings') }}" class="ic-pricePlan__btn">Go To Our Pricing Plans <i
                                class="ri-arrow-right-s-line"></i></a>
                    </div>
                    <div class="ic-pricePlan__card ic-gradient3 mt-30">
                        ...
                        <a href="{{ route('all.bootcamps') }}" class="ic-pricePlan__btn primary">Find Our Bootcamp
                            Training
            ...
            {{-- pickup left --}}
            {{-- saction heading --}}
            <div class="ic-dashboard-heading mt-30 bg-primary">
                <h3 class="fs-28 fw-600 white">Recently Uploaded courses</h3>
                <div class="ic-dashboard-heading-right">
                    ...
                    <a href="{{ route('all.courses') }}" class="ic-btn">View All <i class="ri-arrow-right-line"></i></a>
                </div>
            </div>
            {{-- saction heading --}}
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="ic-coach-item">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <p class="coach-bage ff-exend fs-14 color-white">{{ $item->category->name }}</p>
                                    {{-- <a href="#" class="wishlist"><i class="ri-heart-3-line"></i></a> --}}
                                </div>
                                <div class="ic-coach-content pb-0">
                                    <a href="{{ route('course.details', $item->slug) }}">
                                        <h5 class="fw-500 coach-title ff-lexend">{!! str_limit($item->title, $words = 30, $end = '...') !!}</h5>
                                    </a>
                                    @php
                                    ...
                                    <div class="coach-names">
                                        <p><img src="{{ getStoreFile($item->user->avatar, $item->user->storage_type) }}"
                                                alt="">
                                        ...
                                        <p class="gap-0">
                                            ...
                                            @endif
                                            @for ($i = $filledStars + ($hasHalfStar ? 1 : 0); $i < 5; $i++)
                                                <i class="ri-star-s-line gray-400"></i>
                                            @endfor
                                        </p>
                                    </div>
                                </div>
            ...
            <div class="explore-coaches mt-30"
                style="background-image: linear-gradient(114deg, rgba(8, 157, 82, 0.90) 9.63%, rgba(107, 233, 158, 0.90) 90.37%), url('{{ asset('new-frontend/images/expolre-coaches-banner.png') }}')">
                ...
                <div class="explore-coaches-right">
                    <a href="{{ route('front.allCoaches') }}" class="btn-new-btn">Explore Coaches <i
                            class="ri-arrow-right-s-line"></i></a>
                </div>
            </div>
            {{-- Explore Coaches --}}
            {{-- saction heading --}}
            <div class="ic-dashboard-heading mt-30 bg-primary">
                <h3 class="fs-28 fw-600 white">Recently Uploaded Bootcamps</h3>
                <div class="ic-dashboard-heading-right">
                    {{-- <select name="" id="" class="selectpicker">
            ...
            <option value="0">sani 2 jaksd fjasdf jasdhf jasdfh kjasfh asdfkj haskfhals</option>
                    ...
                    <a href="{{ route('all.bootcamps') }}" class="ic-btn">View All <i
            ...
            <div class="ic-recent-bootcamps-section">
                <div class="row  g-2 g-xl-4">
                    @forelse ($data['bootcamps'] as $item)
                        <div class="col-lg-3 col-md-6">
                            {{-- <div class="ic-courses-items">
                                <a class="black" href="{{ route('bootcamp.details', $item->slug) }}">
                                    <div class="ic-courses-img">
                                        <img src="{{ getStoreFile($item->image, $item->storage_type) }}" alt="">
                                        <span class="course-name tag-text">{{ $item->user->full_name }}</span>
                                    ...
                                    <h5 class="pt-10 pb-10">{{ $item->title }}</h5>
                                </a>
                                <ul class="ic-list-arrows">
                                    ...
                                    <li>
                                        ...
                                        <span>Enrolled - {{ $item->total_enrolled_students }} Students Enroll</span>
                                    </li>
                                </ul>
                                <div class="ic-course-btn">
                                    <a href="{{ route('bootcamp.details', $item->slug) }}" class="ic-booking">Details <i
                                            class="ri-arrow-right-line"></i></a>
                                    <p>$ {{ $item->price }}</p>
                                </div>
                            </div> --}}
            ...
            <div class="ic-forms-tabs">
                <ul>
                    ...
                    <li>
                        <a href="{{ route('student.chat.index') }}">Messages</a>
                    </li>
                </ul>
                <ul>
                    <li>
                        <a href="{{ route('forum.index') }}">View All Forums <i class="ri-arrow-right-line"></i></a>
                    </li>
                </ul>
            </div>
            {{-- forums content --}}
                            ...
                            <div class="forms-list">
                                ...
                                <div class="forms-list--left">
                                    <div class="forms-list--avatar">
                                        <img src="{{ getStoreFile($data['forum']->user->avatar, $data['forum']->user->storage_type) }}"
                                    ...
                                    <div class="forms-list-content">
                                        ...
                                        @if ($latestComment = $data['forum']->comments->last())
                                            <p class="ic-latest-text">
                                                <i class="ri-reply-all-fill"></i>
                                                Latest reply from <a
                                                    href="#">{{ $data['forum']->comments->last()->user->full_name }}</a>
                                                {{ $data['forum']->comments->last()->created_at->diffForHumans() }}
                                            </p>
                                        @endif
                                        <p class="comment-text">
                                            {!! substr(strip_tags($data['forum']->description), 0, 120) . '...' !!}
                                            <a href="{{ route('forum.forumPostDetails', $data['forum']->uuid) }}">Read
                                                More...</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="forms-list--right">
                                    <div class="forms-list-waiting-images">
                                        @foreach ($data['forum']->comments->take(4) as $comment)
                                            <div class="waiting-images">
                                                <a href="#"><img
                                                        src="{{ getStoreFile($comment->user->avatar, $comment->user->storage_type) }}"
                                    ...
                                    <p class="text-right message-conversation">
                                        ...
                                        {{ $data['forum']->comments_count }} Comments
                                    </p>
                                </div>
                            </div>
                        @else
