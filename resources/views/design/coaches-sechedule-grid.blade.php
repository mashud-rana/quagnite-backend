...
@section('content')
    ...
    <div class="ic__blog--background ic__coaching--background"
        ...
        <div class="sechedule-container">
            ...
            {{-- list --}}
            <div
                class="ic-items-list-main ic-items-grid-main  row g-4 row-cols-xxl-4 row-cols-xl-4 row-cols-lg-3 row-cols-sm-2 row-cols-1">
                <div class="col">
                    <div class="ic-items-list mb-0 flex-column">
                        ...
                        <div class="ic-list-conetnt">
                            <p class="sub-title">Data Science Real-Life Data Science Exercises Included</p>
                            <div class="list-conetnt-info">
                                <div class="list-info-items">
                                    <p><i class="ri-calendar-check-fill"></i> 17 January, 2023 - 08:00
                                        AM</p>

                                </div>
                                <div class="list-info-items">
                                    <p><i class="ri-file-list-2-line"></i> 100 Students Enroll</p>
                                </div>
                                <div class="list-info-items">
                                    <p><i class="ri-vidicon-line"></i>35 Pre-Recorded Video</p>
                                </div>
                            </div>
                            <div class="card-btn">
                                <a href="#" class="ic-btn ">Book</a>
