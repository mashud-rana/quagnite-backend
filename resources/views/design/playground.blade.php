            ...
            <div class="ic-codePlayground-innerDiv">
                ...
                <div class="ic-codePlayground-question">
                    ...
                    <ul class="ic-question">
                        ...
                        <li>
                            <div class="form-check p-0 m-0">
                                <label class="form-check-label ic-ques-ans active">
                                    <input class="form-check-input ic-question-checkInput me-2 ms-0" type="radio"
                ...
                <div class="ic-codePlayground-questionMark">
                    <ul class="ic-question-Numbers">
                        ...
                        <li>
                            <img src="{{ asset('frontend/images/award.webp') }}" alt="">
                            <div class="icquestion-show">
                                <p>Pass Marks </p>
                                <p>40%</p>
                            </div>
                    ...
                    <div class="ic-congratulation">
                        ...
                        <p>You have successfull pass</p>
                        <ul class="ic-congra-select">
                            <li>
                                <img src="{{ asset('frontend/images/list.png') }}" alt="">
                                <div class="icquestion-show">
                                    <p>Coreect Answare</p>
                                    <p>4/8</p>
                                </div>
