...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="ic__banner--content ps-0">
                        <span class="white">coaches schedule</span>
                        <h1>All Coaches Schedule</h1>
    ...
    <div class="ic__blog--background ic__coaching--background"
        ...
        <div class="reserve-container">
            ...
            <div class="ic-switch-grid">
                <div class="switch-buttons">
                    <div class="switch-button">
                        <a href="#"><i class="ri-layout-grid-fill"></i> Grid</a>
                        <a href="#" class="active"><i class="ri-file-list-line"></i> List</a>
                    </div>
            ...
            {{-- list --}}
            <div class="ic-items-list-main">
                <div class="ic-items-list">
                    <div class="ic-list-image">
                        <div class="position-relative">
                            <img src="{{ asset('frontend/images/list-pic-1.png') }}" class="img-fluid" alt="">
                    ...
                    <div class="ic-list-conetnt">
                        <ul class="ic-rating-info">
                            <li>
                                <p><svg width="9" height="10" viewBox="0 0 9 10" fill="none"
                            ...
                            <li>
                                <p class="orange">
                                    <svg width="9" height="10" viewBox="0 0 9 10" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="4.5" cy="5" r="4.5" fill="#fff" />
                                    </svg>
                                    Ranking Level 3
                                </p>
                            </li>
                        ...
                        <div class="list-conetnt-info">
                            <div class="list-info-items">
                                <p><i class="ri-calendar-check-fill"></i> Date & Time - 14 to 17 January, 2023 - 08:00 AM
                                </p>
                                <span>
                                    <svg width="9" height="10" viewBox="0 0 9 10" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="list-info-items">
                                <p><i class="ri-file-list-2-line"></i> Enrolled - 100 Students Enroll</p>
                            </div>
                            <div class="list-info-items">
                                <p><i class="ri-vidicon-line"></i> Video - 35 Pre-Recorded Video</p>
                            </div>
                        </div>
                        <div class="card-btn">
                            <a href="#" class="ic-btn ">Book Schedule</a>
                            <h3 class="black">$ 165.00</h3>
                        </div>
                    </div>
                </div>
                <div class="ic-items-list">
